  ...
  return (
    <div className="contact-page">
      <main style={{ paddingTop: '80px', paddingBottom: '120px' }}>
        ...
        {/* 2. CENTERED STACKED LAYOUT SECTION */}
        <section className="contact-content-section">
          <div className="contact-container">
            <div className="contact-grid">
              
              {/* A. INTAKE FORM CONTAINER */}
                  ...
                  <div className="contact-form-container">
                    ...
                    <form onSubmit={handleFormSubmit} className="contact-form-element" noValidate>
                      ...
                      <button type="button" onClick={() => {
                        document.querySelector('.contact-scheduler-wrapper')?.scrollIntoView({ behavior: 'smooth' });
                      }} className="contact-btn contact-btn-secondary full-width mt-3">
                        <i className="far fa-calendar-alt"></i> Or Book a Direct Call Slot
                      </button>
                      ...
                      {DAYS_DATA.map((item, idx) => (
                        <div 
                          ...
                          onClick={() => {
                            ...
                            setSelectedTimeIndex(null); // Reset selected time when day changes
                          }}
                        >
                    ...
                    <div className="scheduler-summary-alert">
                      {selectedTimeIndex !== null ? (
                        <p className="summary-text">
                          <i className="far fa-clock"></i> Selected Slot: <strong>{DAYS_DATA[selectedDayIndex].date} at {TIME_SLOTS[selectedTimeIndex]}</strong> (Standard 30m Meeting)
                        </p>
                      ) : (
              ...
              <div className="contact-trust-card">
                <h3 className="sidebar-section-title">Why Partner With Apitide?</h3>
