...
{/*  HERO (ENTERPRISE HERO - PHASE 11)  */}
  <section className="hero" id="hero">
    ...
    <div className="container">
      <div className="hero-content">
        ...
        {/*  Floating Company Logos Ticker  */}
        <div className="logo-ticker-container">
          <p className="ticker-label">AUTOMATING OPERATIONS ACROSS INDUSTRY LEADING PLATFORMS</p>
          <div className="logo-ticker-track">
            {/*  Set 1  */}
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/stripe/635BFF" alt="Stripe"
                className="si-logo" /> Stripe</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/shopify/96BF48" alt="Shopify"
                className="si-logo" /> Shopify</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/n8n/EA4B71" alt="n8n" className="si-logo" />
              n8n</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/zapier/FF4A00" alt="Zapier"
                className="si-logo" /> Zapier</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/openai/ffffff" alt="OpenAI"
                className="si-logo" /> OpenAI</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/slack/ECB22E" alt="Slack"
                className="si-logo" /> Slack</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/google/4285F4" alt="Google"
                className="si-logo" /> Google</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/airtable/18BFFF" alt="Airtable"
                className="si-logo" /> Airtable</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/whatsapp/25D366" alt="WhatsApp"
                className="si-logo" /> WhatsApp</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/hubspot/FF7A59" alt="HubSpot"
                className="si-logo" /> HubSpot</div>
            <div className="logo-ticker-item"><i className="fab fa-aws" style={{"color": "#FF9900", "fontSize": "1.2rem"}}></i> AWS</div>
            <div className="logo-ticker-item"><img src="https://cdn.simpleicons.org/firebase/FFCA28" alt="Firebase"
                className="si-logo" /> Firebase</div>
        ...
        <div className="hero-stats-grid">
          <div className="hero-stat-item">
            <span className="stat-number stat-number-value" data-target="100" data-suffix="+">0</span>
            <span className="stat-label">Projects</span>
          </div>
          <div className="hero-stat-item">
            <span className="stat-number stat-number-value" data-target="15" data-suffix="+">0</span>
            <span className="stat-label">Countries</span>
          </div>
          <div className="hero-stat-item">
            <span className="stat-number stat-number-value" data-target="50" data-suffix="+">0</span>
            <span className="stat-label">Clients</span>
          </div>
          <div className="hero-stat-item">
            <span className="stat-number stat-number-value" data-target="10000" data-suffix="+">0</span>
            <span className="stat-label">Hours Saved</span>
          </div>
          <div className="hero-stat-item">
            <span className="stat-number stat-number-value" data-target="1.2" data-suffix="M+">0</span>
  ...
  <section className="marquee-section" aria-label="Technology ecosystem">
    ...
    <div className="marquee-track-wrapper">
      <div className="marquee-track">
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/react/61DAFB" alt="React" className="si-logo" /> React
        </div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/nextdotjs/ffffff" alt="Next.js" className="si-logo" />
          Next.js</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/nodedotjs/339933" alt="Node.js" className="si-logo" />
          Node.js</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/fastapi/009688" alt="FastAPI" className="si-logo" />
          FastAPI</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/python/3776AB" alt="Python" className="si-logo" />
          Python</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/docker/2496ED" alt="Docker" className="si-logo" />
          Docker</div>
        <div className="marquee-item"><i className="fab fa-aws" style={{"color": "#FF9900", "fontSize": "1.1rem"}}></i> AWS</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/firebase/FFCA28" alt="Firebase" className="si-logo" />
          Firebase</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/openai/ffffff" alt="OpenAI" className="si-logo" />
          OpenAI</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/langchain/ffffff" alt="LangChain"
            className="si-logo" /> LangChain</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/n8n/EA4B71" alt="n8n" className="si-logo" /> n8n</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/postgresql/4169E1" alt="PostgreSQL"
            className="si-logo" /> PostgreSQL</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/vercel/ffffff" alt="Vercel" className="si-logo" />
          Vercel</div>
    ...
    <div className="marquee-track-wrapper">
      <div className="marquee-track reverse">
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/mongodb/47A248" alt="MongoDB" className="si-logo" />
          MongoDB</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/redis/DC382D" alt="Redis" className="si-logo" /> Redis
        </div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/supabase/3ECF8E" alt="Supabase" className="si-logo" />
          Supabase</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/stripe/635BFF" alt="Stripe" className="si-logo" />
          Stripe</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/whatsapp/25D366" alt="WhatsApp" className="si-logo" />
          WhatsApp API</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/twilio/F22F46" alt="Twilio" className="si-logo" />
          Twilio</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/cloudflare/F38020" alt="Cloudflare"
            className="si-logo" /> Cloudflare</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/microsoftazure/0078D4" alt="Azure"
            className="si-logo" /> Azure</div>
        <div className="marquee-item"><i className="fas fa-microchip" style={{"color": "#00B5B8", "fontSize": "1.1rem"}}></i> Pinecone
        </div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/anthropic/ffffff" alt="Claude AI"
            className="si-logo" /> Claude AI</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/googlegemini/8E75B2" alt="Gemini"
            className="si-logo" /> Gemini</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/laravel/FF2D20" alt="Laravel" className="si-logo" />
          Laravel</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/qdrant/ffffff" alt="Qdrant" className="si-logo" />
          Qdrant</div>
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/shopify/96BF48" alt="Shopify" className="si-logo" />
          Shopify</div>
        {/*  Duplicate  */}
        <div className="marquee-item"><img src="https://cdn.simpleicons.org/mongodb/47A248" alt="MongoDB" className="si-logo" />
          MongoDB</div>
  ...
  <section className="services-cta">
    <div className="container">
      <div className="cta-content">
        ...
        <p>Ready to build intelligent systems and automate repetitive tasks? Let's discuss your targets.</p>
        <div className="cta-buttons" style={{"justifyContent": "center", "display": "flex", "gap": "15px"}}>
          <Link  to="/contact" className="cta-btn orange-btn">Get Free Consultation</Link>
    ...
    <div className="tech-marquee-container">
      ...
      <div className="tech-marquee-wrapper">
        <div className="tech-marquee-track">
          ...
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/google/4285F4" alt="Google" className="si-logo" /> <span>Google</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/airtable/18BFFF" alt="Airtable" className="si-logo" /> <span>Airtable</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/whatsapp/25D366" alt="WhatsApp" className="si-logo" /> <span>WhatsApp</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/hubspot/FF7A59" alt="HubSpot" className="si-logo" /> <span>HubSpot</span></div>
          <div className="tech-marquee-item"><i className="fab fa-aws" style={{"color": "#FF9900", "fontSize": "1.5rem"}}></i> <span>AWS</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/firebase/FFCA28" alt="Firebase" className="si-logo" /> <span>Firebase</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/stripe/635BFF" alt="Stripe" className="si-logo" /> <span>Stripe</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/shopify/96BF48" alt="Shopify" className="si-logo" /> <span>Shopify</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/n8n/EA4B71" alt="n8n" className="si-logo" /> <span>n8n</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/zapier/FF4A00" alt="Zapier" className="si-logo" /> <span>Zapier</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/openai/ffffff" alt="OpenAI" className="si-logo" /> <span>OpenAI</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/react/61DAFB" alt="React" className="si-logo" /> <span>React</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/nextdotjs/ffffff" alt="Next.js" className="si-logo" /> <span>Next.js</span></div>
          <div className="tech-marquee-item"><img src="https://cdn.simpleicons.org/python/3776AB" alt="Python" className="si-logo" /> <span>Python</span></div>
    ...
    <div className="container" style={{"textAlign": "center"}}>
      ...
      <div className="partner-logo-container">
        <h3 className="section-subtitle"
          style={{"textTransform": "uppercase", "fontFamily": "var(--font-mono)", "fontSize": "0.8rem", "marginBottom": "25px", "letterSpacing": "2px"}}>
          Powering Integrations For Leading Brands</h3>
        <div className="partner-grid">
          <div className="partner-logo"><img src="https://cdn.simpleicons.org/n8n/EA4B71" alt="n8n" className="partner-brand-img" /> <span>n8n</span></div>
          <div className="partner-logo"><img src="https://cdn.simpleicons.org/openai/ffffff" alt="OpenAI" className="partner-brand-img" /> <span>OpenAI</span></div>
          <div className="partner-logo"><img src="https://cdn.simpleicons.org/amazonaws/FF9900" alt="AWS" className="partner-brand-img" /> <span>AWS</span></div>
          <div className="partner-logo"><img src="https://cdn.simpleicons.org/hubspot/FF7A59" alt="HubSpot" className="partner-brand-img" /> <span>HubSpot</span></div>
          <div className="partner-logo"><img src="https://cdn.simpleicons.org/stripe/635BFF" alt="Stripe" className="partner-brand-img" /> <span>Stripe</span></div>
          <div className="partner-logo"><img src="https://cdn.simpleicons.org/twilio/F22F46" alt="Twilio" className="partner-brand-img" /> <span>Twilio</span></div>
        </div>
      </div>


      {/*  Impact Stats Grid (7 parameters)  */}
      <h2 className="section-title" style={{"marginTop": "60px"}}>Our Impact <span className="gradient-text-cyan">In Numbers</span>
      </h2>
      <p className="section-subtitle">A verified track record of operational performance metrics built for business owners
        globally.</p>

      <div className="trust-stats-grid">
        {/*  1. Project Count  */}
        <div className="service-card glass-card trust-stat-card scroll-reveal">
          <span className="stat-number-value" data-target="120" data-suffix="+">0</span>
          <p>Projects Delivered</p>
        </div>
        {/*  2. Countries Served  */}
        <div className="service-card glass-card trust-stat-card scroll-reveal">
          <span className="stat-number-value" data-target="12" data-suffix="+">0</span>
          <p>Countries Served</p>
        </div>
        {/*  3. Industries Served  */}
        <div className="service-card glass-card trust-stat-card scroll-reveal">
          <span className="stat-number-value" data-target="15" data-suffix="+">0</span>
          <p>Industries Served</p>
        </div>
        {/*  4. Years Experience  */}
        <div className="service-card glass-card trust-stat-card scroll-reveal">
          <span className="stat-number-value" data-target="3" data-suffix="+">0</span>
          <p>Years Experience</p>
        </div>
      </div>
      <div className="trust-stats-grid-bottom">
        {/*  5. Average Delivery Time  */}
        <div className="service-card glass-card trust-stat-card scroll-reveal">
          <span className="stat-number-value" data-target="14" data-prefix="&lt; " data-suffix=" Days">0</span>
          <p>Average Delivery Time</p>
        </div>
        {/*  6. Client Satisfaction  */}
        <div className="service-card glass-card trust-stat-card scroll-reveal">
          <span className="stat-number-value" data-target="99.2" data-suffix="%">0</span>
          <p>Client Satisfaction</p>
        </div>
        {/*  7. Repeat Clients  */}
        <div className="service-card glass-card trust-stat-card scroll-reveal">
          <span className="stat-number-value" data-target="88" data-suffix="%">0</span>
          <p>Repeat Clients</p>
        </div>
      </div>
  ...
  {/*  LEAD GENERATION RESOURCE HUB & NEWSLETTER (PHASE 21)  */}
  <section className="section-dark-navy" id="resource-hub" style={{"paddingBottom": "0"}}>
    <div className="container">
      <h2 className="section-title">Resource <span className="gradient-text-cyan">Hub</span> & Lead Magnets</h2>
      <p className="section-subtitle">Unlock custom engineering assets, download company indexes, and request free technical blueprints.</p>

      <div className="resource-grid">
        {/*  1. Free AI Audit & Blueprint  */}
        <div className="service-card glass-card resource-card scroll-reveal">
          <span className="resource-badge">Free Resource</span>
          <h3>AI Audit &amp; Automation Blueprint</h3>
          <p>Get a custom-engineered operational map highlighting bottlenecks, integration pathways, and n8n workflow steps specific to your business.</p>
          <Link  to="/contact" className="cta-btn primary small"><i className="fas fa-magic"></i> Request Free Audit</Link>
        </div>

        {/*  2. Download Company Profile  */}
        <div className="service-card glass-card resource-card scroll-reveal">
          <span className="resource-badge">Company File</span>
          <h3>Company Profile &amp; Portfolio</h3>
          <p>Download our complete company profile, detailing client case studies, founder stories, and our core technical standards.</p>
          <Link  to="/contact?resource=profile" className="cta-btn secondary small"><i className="fas fa-file-pdf"></i> Request Company Profile</Link>
        </div>

        {/*  3. Capability Deck  */}
        <div className="service-card glass-card resource-card scroll-reveal">
          <span className="resource-badge">B2B Presentation</span>
          <h3>Enterprise Capability Deck</h3>
          <p>A detailed systems architecture outline, database security features, and custom FastAPI wrapper frameworks for enterprise leaders.</p>
          <Link  to="/contact?resource=deck" className="cta-btn secondary small"><i className="fas fa-download"></i> Request Capability Deck</Link>
        </div>
      </div>

      {/*  Weekly Newsletter  */}
      <div className="newsletter-box scroll-reveal">
        <h3>Join Our Weekly AI Digest</h3>
        <p>Get weekly, dev-written guides on self-hosting n8n workflows, prompt tuning, and B2B software architectures. No spam, just raw code engineering.</p>
        <form className="newsletter-form" id="newsletterForm" onsubmit="handleNewsletterSubmit(event)">
          
          <div className="newsletter-name-row">
            <input type="text" id="newsletter_first_name" name="first_name" className="newsletter-input" placeholder="First Name" style={{"maxWidth": "200px"}} />
            <input type="email" id="newsletter_email" name="email" className="newsletter-input" placeholder="Enter your business email" required />
          </div>
          <button type="submit" className="cta-btn primary" style={{"padding": "14px 28px"}}><i className="fas fa-rocket"></i> Subscribe Now</button>
        </form>
        <p id="newsletter-msg" className="newsletter-msg" style={{"display": "none"}}></p>
      </div>

    </div>
  </section>

  {/*  RESOURCE HUB PROMO BANNER (100% EDGE-TO-EDGE FULL WIDTH)  */}
  <section className="resource-promo-banner-section" style={{"margin": "0", "padding": "0"}}>
    <div className="resource-promo-banner-inner">
      <img src="/static/images/resource_promo_banner.png" alt="Resource Hub Promotion Banner" className="resource-promo-banner-img" />
    </div>
  </section>
